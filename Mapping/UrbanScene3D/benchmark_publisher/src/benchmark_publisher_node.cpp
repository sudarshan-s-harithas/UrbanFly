...
int main(int argc, char **argv)
{
    ...
    pub_odom = n.advertise<nav_msgs::Odometry>("bench_odometry", 1000);
    pub_path = n.advertise<nav_msgs::Path>("bench_path", 1000);

    ros::Subscriber sub_odom = n.subscribe("/rpvio_estimator/odometry", 1000, odom_callback);
