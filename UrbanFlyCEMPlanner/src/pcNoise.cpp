...
void cloud_cb( const sensor_msgs::PointCloud cloud_msg )
{
  ...
  sensor_msgs::PointCloud input_xyz_filtered;
  pcl::toROSMsg(*xyz_cloud_filtered, input_xyz_filtered);
  pub.publish (input_xyz_filtered);
...
int main(int argc, char** argv)
{
    ...
    ros::Subscriber sub = nh.subscribe<sensor_msgs::PointCloud2>("/vins_estimator/point_cloud",1, cloud_cb);
